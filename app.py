...
# File paths
word_pairs_file = "txt files/word_pairs.txt"
used_word_pairs_file = "txt files/used_word_pairs.txt"
synonyms_file = "txt files/synonyms.txt"
used_synonyms_file = "txt files/used_synonyms.txt"
...
def load_word_pair_from_synonyms():
    try:
        with open("txt files/synonyms.txt", "r") as file:
            lines = file.readlines()
            if lines:
